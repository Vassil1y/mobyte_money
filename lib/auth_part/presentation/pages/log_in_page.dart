      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Align(alignment: Alignment.centerLeft, child: TextButton(onPressed: (){Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_)=>const ForgotPasswordPage()), (_)=>false);}, style: TextButton.styleFrom(textStyle: const TextStyle(color: AuthTheme.mainColor)), child: const Text("Forgot password?"))),
              ...
              child: Align(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(onPressed: (){Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_)=>const SignUpPage()), (_)=>false);}, style: TextButton.styleFrom(textStyle: const TextStyle(color: AuthTheme.mainColor)), child: const Text("Sign up"))
                  ],
                ),
              ),
            ),
